...
const OrderedItem = ({ item, key, orderProductDetails }) => {
  ...
  useEffect(() => {
    console.log("ordered item key: ", key);
  }, [key]);
    ...
    >
        ...
        <div className="col">
          <div className="row d-flex justify-content-start text-dark">
            ...
            <div className="col text-end">
              <Link
                href={{
                  pathname: "/orders/parcel-details",
                  query: {
                    specificOrderId: orderProductDetails?.order_id.toString(),
                    specificParcelId:
                      orderProductDetails?.product_id.toString(),
                  },
                }}
              >
                <button className="btn btn-sm text-white color-bg-blue shadow">
                  View Details
                </button>
              </Link>
            </div>
      ...
      <div className="row d-block d-sm-none">
        ...
        <div className="col mb-3 text-center">
          <button className="btn btn-sm btn-primary color-bg-blue rounded-0">
            View Details
          </button>
        </div>
      </div>
