            ...
            <div className="product-detail detail-inline">
              <div className="detail-title">
                ...
                <div className="detail-left">
                  {product.model && (
                    <h6 className="model-number">
                      {product.model_no.substring(0, 12)}
                      {product.model_no.length > 8 ? "..." : ""}
                    </h6>
                  )}
                        ...
                        style={{
                          backgroundColor:
                            selectedCondition === "New"
                              ...
                              : "lightgrey",
                          color:
                            selectedCondition === "New" ? "white" : "black", // Optionally set text color
                        }}
                      >
                        New
                      </span>
                          ...
                          style={{
                            backgroundColor:
                              selectedCondition === "Used"
                                ...
                                : "lightgrey",
                            color:
                              selectedCondition === "Used" ? "white" : "black", // Optionally set text color
                          }}
                        >
                          Used
                        </span>
