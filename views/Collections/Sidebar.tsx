...
const Sidebar: NextPage<SideBarProps> = ({ sub_cat, brand, priceRange }) => {
                    ...
                    {menu.categories.map((category) => (
                      ...
                      >
                        <Accordion.Header
                          onClick={() => {
                            router.push(
                              `${window.location.pathname}?category=${category.id}`,
                              undefined,
                              {
                                shallow: true,
                              }
                        ...
                        <Accordion.Body>
                          <ul>
                            {category.sub_categories.map((subCategory) => (
                              <div
                                className={`p-2 ${
                                  subCategory.id === activeTab ? "active" : ""
                                }`}
                                onClick={() => handleSubClick(subCategory.id)}
                                style={
                                  subCategory.id === activeTab
                                    ? styles.activeLi
                                    : styles.li
                                }
                              >
 ...
 <div className="collection-collapse-block-content" style={{ maxHeight: '150px', overflowY: 'auto' }}>
